...
#define STAGE_LOAD_NOTES      (1 << 4)
#define STAGE_LOAD_FLAG       (1 << 7)

//Stage enums
typedef enum
{
	StageId_1_1, //Dream of Peace
	StageId_1_2, //Diagrapephobia
	StageId_1_3, //Post Mortal
	StageId_1_4, //Plaything
	StageId_1_5, //System Failure
	StageId_1_6, //IM A BANANA
	StageId_1_7, //Intro
...
#define StageId_LastVanilla StageId_1_7
...
typedef struct
{
	...
	//HUD textures
	Gfx_Tex tex_hud0p, tex_hud0e, tex_hud1;
