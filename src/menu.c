...
static const char *funny_messages[][2] = {
	...
	{"MII CHANNEL ON A PSX", "WHAT THE SHIT"},
	{"PLAY THIS ON WIISX", "FOR FULL IMMERSION"},
	{"THERE IS A LETTERBOMB", "IN YOUR MAILBOX"},
	{"PSX PORT INSTEAD OF WII", "NO REASON WHY"},
	{"I WILL PUNT YOU", "ACROSS A FOOTBALL FIELD"},
	{"A MII WITH AN AXE", "ALRIGHTY THEN"},
};
			...
			else
			{
				...
				//Fallthrough
					...
					case 1:
						...
						menu.font_bold.draw(&menu.font_bold, "SNICKERBITZ",   SCREEN_WIDTH2, SCREEN_HEIGHT2,      FontAlign_Center);
						menu.font_bold.draw(&menu.font_bold, "MRRUMBLEROSES",      SCREEN_WIDTH2, SCREEN_HEIGHT2 + 16, FontAlign_Center);
						break;
					
					case 7:
						menu.font_bold.draw(&menu.font_bold, "PSXFUNKIN",    SCREEN_WIDTH2, SCREEN_HEIGHT2 - 32, FontAlign_Center);
	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{"1", StageId_1_7, "deleted", {"DREAM OF PEACE", "DIAGRAPHEPHOBIA", "POST MORTAL"}},
			};
		...
		case MenuPage_Credits:
		{
			static const struct
			{
				...
				{StageId_1_1, "GOT PERMISSION", false},
				{StageId_1_1, "FOR PORT", false},
				{StageId_1_1, "", false},
				{StageId_1_1, "CUCKYDEV", false},
				{StageId_1_1, "MADE PSXFUNKIN", false},
				{StageId_1_1, "", false},
				{StageId_1_1, "OG ETELED MOD", false},
				{StageId_1_1, "", false},
				{StageId_1_1, "THEMASKEDCHRIS", false},
				{StageId_1_1, "DIRECTOR AND ARTIST", false},
				{StageId_1_1, "", false},
				{StageId_1_1, "ANTHEMOVERLOAD", false},
				{StageId_1_1, "MUSIC", false},
				{StageId_1_1, "", false},
				{StageId_1_1, "ASH", false},
				{StageId_1_1, "CODER", false},
				{StageId_1_1, "", false},
				{StageId_1_1, "CERBERA", false},
				{StageId_1_1, "CHARTER", false},
				{StageId_1_1, "", false},
				{StageId_1_1, "ICEYPIE", false},
				{StageId_1_1, "WRITER", false},
				{StageId_1_1, "", false},
				{StageId_1_1, "KIWIBURD", false},
				{StageId_1_1, "WRITER", false},
				{StageId_1_1, "", false},
				{StageId_1_1, "CORRUPTZIE", false},
				{StageId_1_1, "WRITER", false},
				{StageId_1_1, "", false},
				{StageId_1_1, "HTTP AIDEN", false},
				{StageId_1_1, "WRITER", false},
				{StageId_1_1, "", false},
